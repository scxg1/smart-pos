...
import { Search, Bot, X, Sparkles, Loader2 } from 'lucide-react';
  ...
  return (
    <div className="flex h-full">
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden">
        <div className="p-4 border-b border-card-border dark:border-slate-700 bg-white dark:bg-slate-800">
          <div className="flex items-center gap-4">
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                className="w-full pr-11 pl-4 py-3 border border-card-border dark:border-slate-600/50 rounded-2xl text-sm bg-slate-50/50 dark:bg-slate-900/50 text-text-primary dark:text-white focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all shadow-sm"
              />
            </div>
          </div>
              ...
              <button
                ...
                className={`px-5 py-2 rounded-xl text-sm font-bold whitespace-nowrap transition-all duration-300
                  ${selectedCategory === cat
                    ? 'bg-gradient-to-l from-primary to-indigo-600 text-white shadow-md shadow-primary/20 scale-105'
        ...
        <div className="flex-1 overflow-y-auto p-4">
          {productsLoading ? (
            ...
            <div className="grid grid-cols-fill-160 gap-3" style={{ gridTemplateColumns: 'repeat(auto-fill, minmax(160px, 1fr))' }}>
